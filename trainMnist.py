...
parser.add_argument('--data', default='', metavar='./DataSets/MNIST', help='path to dataset')
...
def main():
    ...
    # teacher model
    model_teacher = torchvision.models.resnet18(pretrained=False) # Need to reshape MNIST dataset
    # https://www.hackersrealm.net/post/transfer-learning-using-pretrained-model-python
    # https://stackoverflow.com/questions/71894686/using-pretrained-models-for-mnist-dataset
